...
- Write a **DELETE api /users/:userId** that takes the userId in the path params and marks the  attribute for a user as true. Check that request must contain **x-auth-token** header. If absent, return a suitable error.
